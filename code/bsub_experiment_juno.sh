#!/bin/bash
codeDir="/home/liuj11/tansey_lab/TL/transfer-learning/code" # the directory where expt.py lives
...
dataFile="/home/liuj11/tansey_lab/TL/transfer-learning/data/rep-gdsc-ctd2-mean-log.csv" # input data
